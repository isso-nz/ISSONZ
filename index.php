...
<div data-aos="fade-up" data-aos-duration="800" data-aos-delay="600"  data-aos-once="true" class="w-11/12 shadow sm:shadow-md md:shadow-lg lg:shadow-xl m-auto my-4 h-22 relative">
    <img class="w-full h-full object-cover" src="<?php echo get_template_directory_uri(  ) ?>/src/imgs/video.jpg" alt="">
    <div class="bg-black absolute top-0 left-0 w-full h-full opacity-75"></div>
...
<div data-aos="fade-up" data-aos-duration="800" data-aos-delay="600" data-aos-once="true" class="w-11/12 shadow sm:shadow-md md:shadow-lg lg:shadow-xl p-10 py-16 m-auto my-4 bg-primary md:flex items-center">
    <div>
    ...
    <a class="mt-4 md:my-0 md:ml-auto font-quicksand px-8 py-2 bg-secondaray hover:bg-primary border-secondaray border-2 text-white hover:text-secondaray w-fit flex justify-content items-center duration-300 transition ease-out" href="<?php echo get_home_url() ?>/newsletter">Sign up</a>
</div>
<?php get_footer( ) ?>
