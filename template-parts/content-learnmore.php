...
<div class="display-info mt-4 md:mt-0">
    <div class="flex flex-col md:flex-row">
        <img data-aos="fade-up" data-aos-duration="800" data-aos-once="true" class="w-full md:w-1/2 h-28 object-cover" src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Shaqi_jrvej.jpg/1200px-Shaqi_jrvej.jpg" alt="">
    ...
    <div data-aos="fade-up" data-aos-duration="800" data-aos-once="true" class="flex flex-col-reverse md:flex-row ">
        <div  class="w-full md:w-1/2 flex items-center">
            <div class="p-8">
    ...
    <div data-aos="fade-up" data-aos-duration="800" data-aos-once="true" class="flex flex-col md:flex-row ">
        <img data-aos="fade-up" data-aos-duration="800"  data-aos-once="true"  class="w-full md:w-1/2 h-28 object-cover" src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Shaqi_jrvej.jpg/1200px-Shaqi_jrvej.jpg" alt="">
        <div  class="w-full md:w-1/2 flex items-center">
            <div class="p-8">
